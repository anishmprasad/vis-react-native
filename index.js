	...
	_createClass(Graph, [
		...
		},
		{
			...
			value: function shouldComponentUpdate(nextProps, nextState) {
				...
				if (nodesChange) {
					...
					var nodesRemoved = (0, _differenceWith2.default)(
						this.props.graph.nodes,
						nextProps.graph.nodes,
						idIsEqual
					);
					var nodesAdded = (0, _differenceWith2.default)(
						nextProps.graph.nodes,
						this.props.graph.nodes,
						idIsEqual
					);
					var nodesChanged = (0, _differenceWith2.default)(
						(0, _differenceWith2.default)(nextProps.graph.nodes, this.props.graph.nodes, _isEqual2.default),
						nodesAdded
					);
				...
				if (edgesChange) {
					var edgesRemoved = (0, _differenceWith2.default)(
						this.props.graph.edges,
						nextProps.graph.edges,
						_isEqual2.default
					);
					var edgesAdded = (0, _differenceWith2.default)(
						nextProps.graph.edges,
						this.props.graph.edges,
						_isEqual2.default
					);
				...
				if (eventsChange) {
					...
					try {
						for (
							var _iterator = Object.keys(events)[Symbol.iterator](), _step;
					...
					try {
						for (
							var _iterator2 = Object.keys(events)[Symbol.iterator](), _step2;
		...
		},
		{
			...
			value: function updateGraph() {
				...
				this.Network = new _vis2.default.Network(
					container,
				...
				try {
					for (
						var _iterator3 = Object.keys(events)[Symbol.iterator](), _step3;
		...
		},
		{
			...
			value: function render() {
				...
				return _react2.default.createElement(_reactNative.View, { id: identifier, style: style }, identifier);
			}
		}
	]);
